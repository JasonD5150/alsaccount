...
<fwp:template>
	...
	<sjg:grid
		...
		>
			...
			<sjg:gridColumn name="atgsWhenCreated" index="atgsWhenCreated" title =" Transaction Group Created" width="20" sortable="false" editable="true" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}" formoptions="{colpos:2,rowpos:2}"/>
			...
			<sjg:gridColumn name="atgsSummaryDt" index="atgsSummaryDt" title =" Summary Approval Date" width="15" sortable="false" editable="false" hidden="true" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}" formoptions="{colpos:3,rowpos:5}" searchoptions="{searchhidden: true}"/>
			...
			<sjg:gridColumn name="atgsInterfaceDt" index="atgsInterfaceDt" title =" Interface Approval Date" width="15" sortable="false" editable="false" hidden="true" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}" formoptions="{colpos:3,rowpos:6}" searchoptions="{searchhidden: true}"/>
			<sjg:gridColumn name="atgsWhenUploadToSummary" index="atgsWhenUploadToSummary" sortable="false" editable="true" hidden="true" title ="Date Uploaded to Summary" width="15"  editrules="{edithidden:true}" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}" formoptions="{colpos:1,rowpos:7}" searchoptions="{searchhidden: true}"/>
			...
			<sjg:gridColumn name="atgsFileCreationDt" index="atgsFileCreationDt" sortable="false" editable="true" hidden="true" title ="Date File Created" width="15" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}"  editrules="{edithidden:true}" formoptions="{colpos:2,rowpos:8}"/>
			...
			<sjg:gridColumn name="atgsWhenUploadedToSabhrs" index="atgsWhenUploadedToSabhrs" sortable="false" editable="true" hidden="true" title ="Date Uploaded to SABHRS" width="15"  editrules="{edithidden:true}" formoptions="{colpos:2,rowpos:10}" formatter="date" formatoptions="{newformat : 'm/d/Y', srcformat : 'Y/m/d'}"/>
	...
	<div id="transGroupAppDiv" style="display:none">
		...
		<table>
			...
			<tr>
				...
				<td colspan="2"><s:textfield id="intFileName" name="intFileName" theme="simple" title="Interface File Name" size="50%"/></td>
			</tr>
			<tr>
