   	...
   	<form id='gridFrm'>
   		<table>
    		...
    		<tr>
				...
				<td><s:textfield id="otherTransGrp" name="otherTransGrp" theme="simple" title="Issuing Provider Name" />
    		</tr>
    		<tr>
    		...
    		<tr>
				...
				<td><s:textfield id="recordVoidDt" name="recordVoidDt" theme="simple" title="Issuing Provider Name" /></td>
			</tr>
    		<tr>
				...
				<td><s:textfield id="batchRecDt" name="batchRecDt" theme="simple" title="Issuing Provider Name" />
    		</tr>
    		<tr>
