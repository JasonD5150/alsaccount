...
public class GenAlsSabhrsEntriesAction extends ActionSupport{
	
	private static final long serialVersionUID = 5217638596755074369L;
	private static final Logger log = LoggerFactory.getLogger(GenAlsSabhrsEntriesAction.class);
	...
	public GenAlsSabhrsEntriesAction(){
	}
